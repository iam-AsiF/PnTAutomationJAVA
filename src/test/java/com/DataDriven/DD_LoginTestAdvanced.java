...
public class DD_LoginTestAdvanced {
    ...
    public void TC_Invalid_001() throws InterruptedException {
        ...
        for (int rowNum=2; rowNum<=rowCount; rowNum++){
            ...
            //Pass fail condition and put the result in the Excel file
            //setCellData will write data in the Excel file to the marked column
            ...
            if (Expected_title.equalsIgnoreCase(Actual_title)){
                ...
                reader.setCellData(sheetName,"Expected Result", rowNum,"Login successful, Test failed");
            }
        }
